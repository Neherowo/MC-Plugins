...
import pl.nehorowo.reward.database.api.stereotype.ListSeparator;
import pl.nehorowo.reward.database.api.stereotype.PrimaryKey;
import pl.nehorowo.reward.database.api.stereotype.Value;
import pl.nehorowo.reward.database.helper.ListHelper;
import pl.nehorowo.reward.database.helper.ReflectionHelper;
