package pl.nehorowo.whitelist.command.api;
...
public abstract class CommandAPI extends BukkitCommand {
    ...
    private final WhitelistPlugin instance = WhitelistPlugin.getInstance();
    ...
    private final WhitelistPeopleConfiguration serviceItemsConfiguration = instance.getWhitelistPeopleConfiguration();
